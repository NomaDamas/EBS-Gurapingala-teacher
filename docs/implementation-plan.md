...
현재 상태: Level/persona 설정, 실시간 수신, 학생 heartbeat, online/offline 표시, turn timestamp/latency/Level/preflight verdict 기록, 전체 로그 export, 정정 수업용 오류표 JSON/CSV export, TTL, 삭제 버튼 구현됨.
