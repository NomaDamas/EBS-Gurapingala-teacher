...
const checks = [
  ...
  },
  {
    ...
    run: async (files) =>
      ...
      includesAll(files["test/external-review-evidence.test.js"], ["review:evidence writes structured approval evidence", "CLASSROOM_CONFIG_STATUS", "classroomConfigStatus", "review:evidence rejects approval with blocking findings", "review:evidence rejects approval when CI evidence timestamps are invalid", "review:evidence fails closed"]) &&
