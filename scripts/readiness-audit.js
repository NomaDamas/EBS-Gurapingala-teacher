...
const checks = [
  ...
  },
  {
    ...
    run: async (files) =>
      includesAll(files["docs/production-runbook.md"], ["촬영 전날", "리허설", "촬영 중", "촬영 직후", "데이터 삭제", "Node.js 22", "npm ci", "openaiModel", "openaiTimeoutMs", "EXPECTED_OPENAI_MODEL", "EXPECTED_OPENAI_TIMEOUT_MS", "/api/config", "teacher_config_updated", "/api/health", "/api/debrief.csv"]) &&
