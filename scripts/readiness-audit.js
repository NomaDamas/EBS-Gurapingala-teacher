...
const checks = [
  ...
  },
  {
    ...
    run: async (files) =>
      ...
      includesAll(files["test/verify-ci.test.js"], ["verify:ci writes commit-bound CI evidence", "verify:ci fails when PR head or check run does not match", "ci-evidence/v1"]) &&
