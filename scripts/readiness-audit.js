...
const checks = [
  ...
  },
  {
    ...
    run: async (files) =>
      includesAll(files["src/ui/teacher.js"], ["/ws/teacher", "학생 카드", "teacher_config", "snapshot"]) &&
  ...
  },
  {
    ...
    run: async (files) =>
      includesAll(files["src/domain/session-export.js"], ["buildDebriefRows", "correctAnswer", "whyFalse"]) &&
      includesAll(files["src/ui/teacher.js"], ["/api/debrief", "정정 수업 오류표"]) &&
