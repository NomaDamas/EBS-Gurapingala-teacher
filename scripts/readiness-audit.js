...
const checks = [
  ...
  },
  {
    ...
    run: async (files) =>
      ...
      includesAll(files["package.json"], ["\"node\": \">=22.0.0\"", "preflight:deploy", "classroom:urls", "verify:deploy", "rehearsal:config", "release:commands"]) &&
