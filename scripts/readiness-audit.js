...
const checks = [
  ...
  },
  {
    ...
    run: async (files) =>
      ...
      includesAll(files["test/external-review-packet.test.js"], ["review:packet prints current PR target", "PR_HEAD_SHA=abc123", "EXPECTED_CLASSROOM_ROOMS=2026-07-13-3-5,2026-07-16-3-1", "REQUIRE_CLASSROOM_CHAT_PROOF=true", "npm run review:evidence"]) &&
