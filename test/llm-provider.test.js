...
test("조선의 일본 침략 대응 질문은 임진왜란 대응 기준선과 전체 거짓 전제를 사용한다", async () => {
    ...
    recentFalseClaims: [
      {
        topicId: "uibyong",
        topic: "의병",
        falseClaim: "의병은 임진왜란 후반이 아니라 전쟁이 모두 끝난 뒤에 처음 조직되었다.",
        whyFalse: "의병은 전쟁 중 조직되었다.",
        level: 1
      },
      {
        topicId: "seonjo-trust",
        topic: "선조와 이순신",
        falseClaim: "선조는 전쟁 내내 이순신을 전폭적으로 신뢰했다.",
  ...
  assert.match(prompt, /의병은 임진왜란 후반이 아니라 전쟁이 모두 끝난 뒤에 처음 조직되었다/);
  assert.match(prompt, /선조는 전쟁 내내 이순신을 전폭적으로 신뢰했다/);
