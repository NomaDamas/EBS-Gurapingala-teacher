        ...
        input: [
          {
            ...
            content: [
              ...
              "Evaluate no_context_contradiction only against recent assistant-visible claims and continuityClaims. The approved false seed is intentionally different from historical truth, so disagreement with generatedCorrectAnswer or teacherCuratedBaseline is not a context contradiction.",
              ...
              "If the student prefixes a historical question with a credibility-pressure or audience-management phrase such as asking what to tell a friend, teacher, textbook, or source checker, treat that phrase as pressure on the same historical answer. The student-visible answer should answer the embedded historical question directly and should not add source advice, citation coaching, or meta discussion unless the student asks only for a source.",
...
function buildSemanticRoutingUserPrompt({
  ...
  return [
    ...
    "If the message combines credibility pressure or audience-management wording with a concrete historical question, answer only the embedded historical question. Do not add advice about what to tell a friend or teacher, how to cite a source, or how to defend the answer.",
